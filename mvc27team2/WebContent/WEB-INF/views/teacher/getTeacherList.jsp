...
<body>
	...
	<div class="title">
		<img alt="addTeacher" src="${pageContext.request.contextPath}/image/getTeacherList.png">
	</div>
			...
			<tbody>
				<c:forEach var="teacher" items="${list}">
					<tr>
						...
						<td>
							<a href="${pageContext.request.contextPath}/addTeacherAddrController.team2?teacherNo=${teacher.teacherNo}">주소추가 <span class="badge badge-primary badge-pill">${teacher.teacherAddrCount}</span></a>
						</td>
						<td>
							<a href="${pageContext.request.contextPath}/updateTeacherController.team2?teacherNo=${teacher.teacherNo}">수정하기</a>
						</td>
						<td>
							<a class="delete" href="${pageContext.request.contextPath}/deleteTeacherController.team2?teacherNo=${teacher.teacherNo}" >삭제하기</a>
						</td>
					</tr>
				</c:forEach>
			</tbody>
		...
		<div id="paging">
			<ul class="pagination pagination-sm">
				<c:if test="${pageMaker.totalCurrentPage > 1}">
					<li class="page-item">
				      <a class="page-link" href="${pageContext.request.contextPath}/getTeacherListController.team2">&laquo;</a>
				    </li>
					<li class="page-item">
				      <a class="page-link" href="${pageContext.request.contextPath}/getTeacherListController.team2?currentPage=${pageMaker.totalCurrentPage - 1}">이전</a>
				    </li>
				</c:if>
				<c:forEach var="pageNumber" items="${pageNumber}">
					<li id="pageNumber" class="page-item">
				      <a class="page-link" id="${pageNumber}" href="${pageContext.request.contextPath}/getTeacherListController.team2?currentPage=${pageNumber}">${pageNumber}</a>
				    </li>
				</c:forEach>
				<c:if test="${pageMaker.totalCurrentPage < pageMaker.totalPage}">
					<li class="page-item">
				      <a class="page-link" href="${pageContext.request.contextPath}/getTeacherListController.team2?currentPage=${pageMaker.totalCurrentPage + 1}">다음</a>
				    </li>
					<li class="page-item">
				      <a class="page-link" href="${pageContext.request.contextPath}/getTeacherListController.team2?currentPage=${pageMaker.totalPage}">&raquo;</a>
				    </li>
				</c:if>
			</ul>
		</div>
