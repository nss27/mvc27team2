...
<body>
	...
	<div class="title">
		<img alt="addTeacher" src="${pageContext.request.contextPath}/image/getTeacheraddrList.png">
	</div>
					...
					<tr>
						<th scope="col">
							<div class="custom-control custom-checkbox">
								...
								<label class="custom-control-label" for="allAddrNo">teacherAddrNo</label>
							</div>
						</th>
						<th scope="col">
							teacherNo
				...
				<tbody>
					<c:forEach var="teacherAddr" items="${list}">
						<tr>
							<th scope="row">
								<div class="custom-control custom-checkbox">
									<input type="checkbox" class="custom-control-input" id="${teacherAddr.teacherAddrNo}" name="teacherAddrNo" value="${teacherAddr.teacherAddrNo}">
									<label class="custom-control-label" for="${teacherAddr.teacherAddrNo}">${teacherAddr.teacherAddrNo}</label>
								</div>
							</th>
							<td>
			...
			<div id="paging">
				<ul class="pagination pagination-sm">
					<c:if test="${pageMaker.totalCurrentPage > 1}">
						<li class="page-item">
					      <a class="page-link" href="${pageContext.request.contextPath}/getTeacherAddrListController.team2">&laquo;</a>
					    </li>
						<li class="page-item">
					      <a class="page-link" href="${pageContext.request.contextPath}/getTeacherAddrListController.team2?currentPage=${pageMaker.totalCurrentPage - 1}&teacherSelect=${teacherSelect}&teacherSearch=${teacherSearch}">이전</a>
					    </li>
					</c:if>
					<c:forEach var="pageNumber" items="${pageNumber}">
						<li id="pageNumber" class="page-item">
					      <a class="page-link" id="${pageNumber}" href="${pageContext.request.contextPath}/getTeacherAddrListController.team2?currentPage=${pageNumber}&teacherSelect=${teacherSelect}&teacherSearch=${teacherSearch}">${pageNumber}</a>
					    </li>
					</c:forEach>
					<c:if test="${pageMaker.totalCurrentPage < pageMaker.totalPage}">
						<li class="page-item">
					      <a class="page-link" href="${pageContext.request.contextPath}/getTeacherAddrListController.team2?currentPage=${pageMaker.totalCurrentPage + 1}&teacherSelect=${teacherSelect}&teacherSearch=${teacherSearch}">다음</a>
					    </li>
						<li class="page-item">
					      <a class="page-link" href="${pageContext.request.contextPath}/getTeacherAddrListController.team2?currentPage=${pageMaker.totalPage}&teacherSelect=${teacherSelect}&teacherSearch=${teacherSearch}">&raquo;</a>
					    </li>
					</c:if>
				</ul>
			</div>
