...
<body>
	...
	<div class="title">
		<img alt="addTeacheraddrList" src="${pageContext.request.contextPath}/image/addTeacheraddrList.png">
	</div>
	...
	<div id="form">
		...
		<br>
		<form action="${pageContext.request.contextPath}/addTeacherAddrController.team2" method="post">
			<fieldset>
				...
				<button type="button" id="add" class="btn btn-outline-primary btn-lg btn-block">teacherAddress 추가</button>
			</fieldset>
		</form>
	</div>
</body>
