...
<body>
	...
	<h2>addEmployee</h2>
	<div id="form">
		<form method = "post" action="<%=request.getContextPath()%>/employeeController.team2" class="form-horizontal">
			 <div class="employeeId form-group has-feedback">
				<label for="employeeId" class="col-sm-2 control-label">employee_id</label>
				<div class="col-sm-10">
					<input type="text" name="employeeId" class="employeeId form-control">
			...
			<div class="employeePw form-group has-feedback">
				...
				<div class="col-sm-10">
					<input type="password" name="employeePw" class="employeePw form-control">
			...
			<div class="employeePwCheck form-group has-feedback">
				...
				<div class="col-sm-10">
					<input type="password" name="employeePwCheck" class="employeePwCheck form-control">
					<span class="employeePwCheck form-control-feedback"></span>
					<p class="employeePwCheck">비밀번호가 일치하지 않습니다</p>
				</div>
			</div>
	      	<button type="submit" class="btn btn-primary btn-lg btn-block">employee추가</button>
		</form>
	</div>
</body>
</html>
