	...
	<div class="center-block">
		<div id="student" class="row">
			<div class="col-xs-6 col-md-4">
				<a href="${pageContext.request.contextPath}/addStudentController.team2">
					<div class="thumbnail">
						<img src="${pageContext.request.contextPath}/image/성수3.jpg" alt="...">
						<div class="caption">
			...
			<div class="col-xs-6 col-md-4">
				<a href="${pageContext.request.contextPath}/getStudentListController.team2">
					<div class="thumbnail">
						<img src="${pageContext.request.contextPath}/image/성수2.jpg" alt="...">
						<div class="caption">
			...
			<div class="col-xs-6 col-md-4">
				<a href="${pageContext.request.contextPath}/getStudentAddrListController.team2">
					<div class="thumbnail">
						<img src="${pageContext.request.contextPath}/image/성수1.jpg" alt="...">
						<div class="caption">
		...
		<div id="employee" class="row">
			<div class="col-xs-6 col-md-4">
				<a href="${pageContext.request.contextPath}/addEmployeeController.team2">
					<div class="thumbnail">
			...
			<div class="col-xs-6 col-md-4">
				<a href="${pageContext.request.contextPath}/getEmployeeListController.team2">
					<div class="thumbnail">
			...
			<div class="col-xs-6 col-md-4">
				<a href="${pageContext.request.contextPath}/getEmplyeeAddrListController.team2">
					<div class="thumbnail">
