...
public class AddTeacherAddrController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		this.teacher = teacherDao.selectTeacherOne(teacherNo); 
		request.setAttribute("teacherNo", this.teacher.getTeacherNo());
		request.setAttribute("teacherId", this.teacher.getTeacherId());
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		this.teacherAddr = new TeacherAddr();
		//값 셋팅
		this.teacherAddr.setTeacherNo(teacherNo);
		this.teacherAddr.setAddress(address);
		//메소드를 사용하기 위해 Dao 호출
		TeacherAddrDao teacherAddrDao = new TeacherAddrDao();
		teacherAddrDao.insertTeacherAddr(this.teacherAddr);
